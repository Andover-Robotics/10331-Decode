...
@Autonomous(name="Close Blue Solo", group="Backup Autos")
public class CloseBlueSolo extends LinearOpMode {
    Bot bot;
    ...
    public static Vector2d gatePos=new Vector2d(3,-45);
...
//               .afterTime(0.01,bot.intake.actionIntakeClose())
                .strafeToSplineHeading(thirdIntake2,Math.toRadians(-95))
