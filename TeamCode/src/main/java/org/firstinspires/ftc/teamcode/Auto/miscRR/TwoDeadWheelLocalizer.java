...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1410.1987265867679; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1682.1095523739793; // x position of the perpendicular encoder (in tick units)
    }
